...
This is based on the number of new cards per day limit

By default, suspended cards are not counted. Additionally this will intentionally not count "today only" limits. Only changes to presets and per deck limits will affect the numbers
